...
{
    class TlRpcBadMsgException : TlInternalException
    {
        public int Code { get; }

        public TlRpcBadMsgException(int code, Some<string> msg) : base(msg, None)
        {
            Code = code;
        }
    }
    ...
    {
        public static TlRpcBadMsgException ToException(BadMsgNotification.Tag error)
        {
            var code = error.ErrorCode;
            TlRpcBadMsgException Ex(string msg) => new TlRpcBadMsgException(code, msg);
