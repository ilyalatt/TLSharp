...
namespace TLSharp.Rpc.Types
{
    public sealed class ImportedContact : ITlType, IEquatable<ImportedContact>, IComparable<ImportedContact>, IComparable
    {
        ...
        public bool Equals(ImportedContact other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(ImportedContact other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
