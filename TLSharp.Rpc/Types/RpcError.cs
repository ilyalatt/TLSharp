...
namespace TLSharp.Rpc.Types
{
    public sealed class RpcError : ITlType, IEquatable<RpcError>, IComparable<RpcError>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x2144ca19;
        ...
        internal static RpcError Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x2144ca19: return (RpcError) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x2144ca19 });
            }
        }
