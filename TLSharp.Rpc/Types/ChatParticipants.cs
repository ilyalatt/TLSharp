...
namespace TLSharp.Rpc.Types
{
    public sealed class ChatParticipants : ITlType, IEquatable<ChatParticipants>, IComparable<ChatParticipants>, IComparable
    {
        public sealed class ForbiddenTag : ITlTypeTag, IEquatable<ForbiddenTag>, IComparable<ForbiddenTag>, IComparable
        {
            ...
            public readonly Option<T.ChatParticipant> SelfParticipant;
        ...
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly int ChatId;
            public readonly Arr<T.ChatParticipant> Participants;
        ...
        public bool Equals(ChatParticipants other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(ChatParticipants other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
