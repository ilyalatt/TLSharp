...
namespace TLSharp.Rpc.Types
{
    public sealed class InputBotInlineMessageId : ITlType, IEquatable<InputBotInlineMessageId>, IComparable<InputBotInlineMessageId>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x890c3d89;
        ...
        internal static InputBotInlineMessageId Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x890c3d89: return (InputBotInlineMessageId) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x890c3d89 });
            }
        }
