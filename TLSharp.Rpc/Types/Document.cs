...
namespace TLSharp.Rpc.Types
{
    public sealed class Document : ITlType, IEquatable<Document>, IComparable<Document>, IComparable
    {
        ...
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly T.PhotoSize Thumb;
        ...
        public bool Equals(Document other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(Document other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
