...
namespace TLSharp.Rpc.Types
{
    public sealed class MsgsStateInfo : ITlType, IEquatable<MsgsStateInfo>, IComparable<MsgsStateInfo>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x04deb57d;
        ...
        internal static MsgsStateInfo Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x04deb57d: return (MsgsStateInfo) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x04deb57d });
            }
        }
