...
namespace TLSharp.Rpc.Types
{
    public sealed class WallPaper : ITlType, IEquatable<WallPaper>, IComparable<WallPaper>, IComparable
    {
        ...
        public sealed class SolidTag : ITlTypeTag, IEquatable<SolidTag>, IComparable<SolidTag>, IComparable
        {
            ...
            public bool Equals(SolidTag other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
            ...
            public int CompareTo(SolidTag other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
        ...
        public bool Equals(WallPaper other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(WallPaper other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
