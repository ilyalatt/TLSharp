...
namespace TLSharp.Rpc.Types
{
    public sealed class AccountDaysTtl : ITlType, IEquatable<AccountDaysTtl>, IComparable<AccountDaysTtl>, IComparable
    {
        ...
        public bool Equals(AccountDaysTtl other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(AccountDaysTtl other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
