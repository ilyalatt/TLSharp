...
namespace TLSharp.Rpc.Types.Help
{
    public sealed class InviteText : ITlType, IEquatable<InviteText>, IComparable<InviteText>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x18cb9f78;
        ...
        internal static InviteText Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x18cb9f78: return (InviteText) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x18cb9f78 });
            }
        }
