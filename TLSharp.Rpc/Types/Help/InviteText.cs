...
namespace TLSharp.Rpc.Types.Help
{
    public sealed class InviteText : ITlType, IEquatable<InviteText>, IComparable<InviteText>, IComparable
    {
        ...
        public bool Equals(InviteText other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(InviteText other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
