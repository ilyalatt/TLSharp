...
namespace TLSharp.Rpc.Types.Help
{
    public sealed class Support : ITlType, IEquatable<Support>, IComparable<Support>, IComparable
    {
        ...
        public bool Equals(Support other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(Support other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
