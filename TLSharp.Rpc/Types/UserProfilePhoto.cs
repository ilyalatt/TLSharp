...
namespace TLSharp.Rpc.Types
{
    public sealed class UserProfilePhoto : ITlType, IEquatable<UserProfilePhoto>, IComparable<UserProfilePhoto>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x4f11bae1;
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xd559d8c8;
        ...
        internal static UserProfilePhoto Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x4f11bae1: return (UserProfilePhoto) EmptyTag.DeserializeTag(br);
                case 0xd559d8c8: return (UserProfilePhoto) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x4f11bae1, 0xd559d8c8 });
            }
        }
