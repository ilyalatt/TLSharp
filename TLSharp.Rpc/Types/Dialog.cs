...
namespace TLSharp.Rpc.Types
{
    public sealed class Dialog : ITlType, IEquatable<Dialog>, IComparable<Dialog>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x66ffba14;
        ...
        internal static Dialog Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x66ffba14: return (Dialog) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x66ffba14 });
            }
        }
