...
namespace TLSharp.Rpc.Types
{
    public sealed class ClientDhInnerData : ITlType, IEquatable<ClientDhInnerData>, IComparable<ClientDhInnerData>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x6643b654;
        ...
        internal static ClientDhInnerData Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x6643b654: return (ClientDhInnerData) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x6643b654 });
            }
        }
