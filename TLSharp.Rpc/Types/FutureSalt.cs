...
namespace TLSharp.Rpc.Types
{
    public sealed class FutureSalt : ITlType, IEquatable<FutureSalt>, IComparable<FutureSalt>, IComparable
    {
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly int ValidSince;
        ...
        public bool Equals(FutureSalt other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(FutureSalt other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
