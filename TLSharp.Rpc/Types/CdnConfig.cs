...
namespace TLSharp.Rpc.Types
{
    public sealed class CdnConfig : ITlType, IEquatable<CdnConfig>, IComparable<CdnConfig>, IComparable
    {
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly Arr<T.CdnPublicKey> PublicKeys;
        ...
        public bool Equals(CdnConfig other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(CdnConfig other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
