...
namespace TLSharp.Rpc.Types
{
    public sealed class EncryptedFile : ITlType, IEquatable<EncryptedFile>, IComparable<EncryptedFile>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xc21f497e;
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x4a70994c;
        ...
        internal static EncryptedFile Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xc21f497e: return (EncryptedFile) EmptyTag.DeserializeTag(br);
                case 0x4a70994c: return (EncryptedFile) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xc21f497e, 0x4a70994c });
            }
        }
