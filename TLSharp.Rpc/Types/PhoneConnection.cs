...
namespace TLSharp.Rpc.Types
{
    public sealed class PhoneConnection : ITlType, IEquatable<PhoneConnection>, IComparable<PhoneConnection>, IComparable
    {
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly Arr<byte> PeerTag;
        ...
        public bool Equals(PhoneConnection other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(PhoneConnection other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
