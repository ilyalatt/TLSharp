...
namespace TLSharp.Rpc.Types
{
    public sealed class HttpWait : ITlType, IEquatable<HttpWait>, IComparable<HttpWait>, IComparable
    {
        ...
        public bool Equals(HttpWait other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(HttpWait other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
