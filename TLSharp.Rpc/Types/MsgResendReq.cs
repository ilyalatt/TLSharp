...
namespace TLSharp.Rpc.Types
{
    public sealed class MsgResendReq : ITlType, IEquatable<MsgResendReq>, IComparable<MsgResendReq>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x7d861a08;
        ...
        internal static MsgResendReq Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x7d861a08: return (MsgResendReq) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x7d861a08 });
            }
        }
