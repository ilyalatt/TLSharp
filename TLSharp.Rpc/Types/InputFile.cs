...
namespace TLSharp.Rpc.Types
{
    public sealed class InputFile : ITlType, IEquatable<InputFile>, IComparable<InputFile>, IComparable
    {
        ...
        public sealed class BigTag : ITlTypeTag, IEquatable<BigTag>, IComparable<BigTag>, IComparable
        {
            ...
            public bool Equals(BigTag other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
            ...
            public int CompareTo(BigTag other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
        ...
        public bool Equals(InputFile other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(InputFile other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
