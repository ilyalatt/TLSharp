...
namespace TLSharp.Rpc.Types
{
    public sealed class TopPeerCategoryPeers : ITlType, IEquatable<TopPeerCategoryPeers>, IComparable<TopPeerCategoryPeers>, IComparable
    {
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly T.TopPeerCategory Category;
            public readonly int Count;
            public readonly Arr<T.TopPeer> Peers;
        ...
        public bool Equals(TopPeerCategoryPeers other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(TopPeerCategoryPeers other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
