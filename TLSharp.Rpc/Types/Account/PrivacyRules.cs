...
namespace TLSharp.Rpc.Types.Account
{
    public sealed class PrivacyRules : ITlType, IEquatable<PrivacyRules>, IComparable<PrivacyRules>, IComparable
    {
        ...
        public bool Equals(PrivacyRules other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(PrivacyRules other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
