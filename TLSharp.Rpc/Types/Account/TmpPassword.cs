...
namespace TLSharp.Rpc.Types.Account
{
    public sealed class TmpPassword : ITlType, IEquatable<TmpPassword>, IComparable<TmpPassword>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xdb64fd34;
        ...
        internal static TmpPassword Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xdb64fd34: return (TmpPassword) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xdb64fd34 });
            }
        }
