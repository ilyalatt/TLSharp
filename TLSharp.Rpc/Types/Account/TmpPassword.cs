...
namespace TLSharp.Rpc.Types.Account
{
    public sealed class TmpPassword : ITlType, IEquatable<TmpPassword>, IComparable<TmpPassword>, IComparable
    {
        ...
        public bool Equals(TmpPassword other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(TmpPassword other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
