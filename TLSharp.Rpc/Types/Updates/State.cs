...
namespace TLSharp.Rpc.Types.Updates
{
    public sealed class State : ITlType, IEquatable<State>, IComparable<State>, IComparable
    {
        ...
        public bool Equals(State other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(State other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
