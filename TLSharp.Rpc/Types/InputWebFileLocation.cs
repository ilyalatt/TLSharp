...
namespace TLSharp.Rpc.Types
{
    public sealed class InputWebFileLocation : ITlType, IEquatable<InputWebFileLocation>, IComparable<InputWebFileLocation>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xc239d686;
        ...
        internal static InputWebFileLocation Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xc239d686: return (InputWebFileLocation) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xc239d686 });
            }
        }
