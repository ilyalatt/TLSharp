...
namespace TLSharp.Rpc.Types
{
    public sealed class InputBotInlineResult : ITlType, IEquatable<InputBotInlineResult>, IComparable<InputBotInlineResult>, IComparable
    {
        ...
        {
            internal const uint TypeNumber = 0x88bf9319;
            ...
            public readonly Option<T.InputWebDocument> Thumb;
            public readonly Option<T.InputWebDocument> Content;
            ...
            public Tag(
                ...
                Option<string> url,
                Option<T.InputWebDocument> thumb,
                Option<T.InputWebDocument> content,
            ...
            (string, string, Option<string>, Option<string>, Option<string>, Option<T.InputWebDocument>, Option<T.InputWebDocument>, T.InputBotInlineMessage) CmpTuple =>
            ...
            void ITlSerializable.Serialize(BinaryWriter bw)
            {
                ...
                Write(Thumb, bw, WriteOption<T.InputWebDocument>(WriteSerializable));
                Write(Content, bw, WriteOption<T.InputWebDocument>(WriteSerializable));
            ...
            internal static Tag DeserializeTag(BinaryReader br)
            {
                ...
                var thumb = Read(br, ReadOption(flags, 4, T.InputWebDocument.Deserialize));
                var content = Read(br, ReadOption(flags, 5, T.InputWebDocument.Deserialize));
