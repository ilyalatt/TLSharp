...
namespace TLSharp.Rpc.Types
{
    public sealed class ServerDhInnerData : ITlType, IEquatable<ServerDhInnerData>, IComparable<ServerDhInnerData>, IComparable
    {
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly Arr<byte> DhPrime;
        ...
        public bool Equals(ServerDhInnerData other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(ServerDhInnerData other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
