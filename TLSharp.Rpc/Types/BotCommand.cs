...
namespace TLSharp.Rpc.Types
{
    public sealed class BotCommand : ITlType, IEquatable<BotCommand>, IComparable<BotCommand>, IComparable
    {
        ...
        public bool Equals(BotCommand other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(BotCommand other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
