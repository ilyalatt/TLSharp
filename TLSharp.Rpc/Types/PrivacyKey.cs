...
namespace TLSharp.Rpc.Types
{
    public sealed class PrivacyKey : ITlType, IEquatable<PrivacyKey>, IComparable<PrivacyKey>, IComparable
    {
        ...
        public bool Equals(PrivacyKey other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(PrivacyKey other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
