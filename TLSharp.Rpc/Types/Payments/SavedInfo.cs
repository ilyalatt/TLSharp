...
namespace TLSharp.Rpc.Types.Payments
{
    public sealed class SavedInfo : ITlType, IEquatable<SavedInfo>, IComparable<SavedInfo>, IComparable
    {
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly bool HasSavedCredentials;
        ...
        public bool Equals(SavedInfo other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(SavedInfo other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
