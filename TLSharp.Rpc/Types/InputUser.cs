...
namespace TLSharp.Rpc.Types
{
    public sealed class InputUser : ITlType, IEquatable<InputUser>, IComparable<InputUser>, IComparable
    {
        ...
        public bool Equals(InputUser other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(InputUser other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
