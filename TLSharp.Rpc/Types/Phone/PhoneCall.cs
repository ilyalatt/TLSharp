...
namespace TLSharp.Rpc.Types.Phone
{
    public sealed class PhoneCall : ITlType, IEquatable<PhoneCall>, IComparable<PhoneCall>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xec82e140;
        ...
        internal static PhoneCall Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xec82e140: return (PhoneCall) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xec82e140 });
            }
        }
