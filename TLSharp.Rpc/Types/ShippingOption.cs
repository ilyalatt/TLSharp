...
namespace TLSharp.Rpc.Types
{
    public sealed class ShippingOption : ITlType, IEquatable<ShippingOption>, IComparable<ShippingOption>, IComparable
    {
        ...
        public bool Equals(ShippingOption other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(ShippingOption other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
