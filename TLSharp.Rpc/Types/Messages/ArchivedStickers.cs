...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class ArchivedStickers : ITlType, IEquatable<ArchivedStickers>, IComparable<ArchivedStickers>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x4fcba9c8;
        ...
        internal static ArchivedStickers Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x4fcba9c8: return (ArchivedStickers) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x4fcba9c8 });
            }
        }
