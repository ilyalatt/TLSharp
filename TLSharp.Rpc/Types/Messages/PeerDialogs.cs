...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class PeerDialogs : ITlType, IEquatable<PeerDialogs>, IComparable<PeerDialogs>, IComparable
    {
        ...
        public bool Equals(PeerDialogs other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(PeerDialogs other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
