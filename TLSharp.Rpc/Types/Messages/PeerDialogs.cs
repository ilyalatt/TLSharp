...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class PeerDialogs : ITlType, IEquatable<PeerDialogs>, IComparable<PeerDialogs>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x3371c354;
        ...
        internal static PeerDialogs Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x3371c354: return (PeerDialogs) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x3371c354 });
            }
        }
