...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class AffectedMessages : ITlType, IEquatable<AffectedMessages>, IComparable<AffectedMessages>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x84d19185;
        ...
        internal static AffectedMessages Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x84d19185: return (AffectedMessages) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x84d19185 });
            }
        }
