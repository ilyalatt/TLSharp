...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class AffectedHistory : ITlType, IEquatable<AffectedHistory>, IComparable<AffectedHistory>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xb45c69d1;
        ...
        internal static AffectedHistory Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xb45c69d1: return (AffectedHistory) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xb45c69d1 });
            }
        }
