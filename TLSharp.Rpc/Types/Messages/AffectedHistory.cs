...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class AffectedHistory : ITlType, IEquatable<AffectedHistory>, IComparable<AffectedHistory>, IComparable
    {
        ...
        public bool Equals(AffectedHistory other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(AffectedHistory other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
