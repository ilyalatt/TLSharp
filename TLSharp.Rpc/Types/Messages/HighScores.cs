...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class HighScores : ITlType, IEquatable<HighScores>, IComparable<HighScores>, IComparable
    {
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly Arr<T.HighScore> Scores;
        ...
        public bool Equals(HighScores other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(HighScores other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
