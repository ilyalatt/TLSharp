...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class BotResults : ITlType, IEquatable<BotResults>, IComparable<BotResults>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xccd3563d;
        ...
        internal static BotResults Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xccd3563d: return (BotResults) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xccd3563d });
            }
        }
