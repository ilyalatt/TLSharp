...
namespace TLSharp.Rpc.Types.Messages
{
    public sealed class StickerSet : ITlType, IEquatable<StickerSet>, IComparable<StickerSet>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xb60a24a6;
        ...
        internal static StickerSet Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xb60a24a6: return (StickerSet) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xb60a24a6 });
            }
        }
