...
namespace TLSharp.Rpc.Types.Contacts
{
    public sealed class Blocked : ITlType, IEquatable<Blocked>, IComparable<Blocked>, IComparable
    {
        public sealed class Tag : ITlTypeTag, IEquatable<Tag>, IComparable<Tag>, IComparable
        {
            ...
            public readonly Arr<T.ContactBlocked> Blocked;
        ...
        public bool Equals(Blocked other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(Blocked other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
