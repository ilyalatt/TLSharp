...
namespace TLSharp.Rpc.Types
{
    public sealed class TopPeer : ITlType, IEquatable<TopPeer>, IComparable<TopPeer>, IComparable
    {
        ...
        public bool Equals(TopPeer other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(TopPeer other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
