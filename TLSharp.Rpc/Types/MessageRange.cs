...
namespace TLSharp.Rpc.Types
{
    public sealed class MessageRange : ITlType, IEquatable<MessageRange>, IComparable<MessageRange>, IComparable
    {
        ...
        public bool Equals(MessageRange other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(MessageRange other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
