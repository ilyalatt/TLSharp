...
namespace TLSharp.Rpc.Types.Auth
{
    public sealed class ExportedAuthorization : ITlType, IEquatable<ExportedAuthorization>, IComparable<ExportedAuthorization>, IComparable
    {
        ...
        public bool Equals(ExportedAuthorization other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(ExportedAuthorization other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
