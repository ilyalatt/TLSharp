...
namespace TLSharp.Rpc.Types
{
    public sealed class GeoPoint : ITlType, IEquatable<GeoPoint>, IComparable<GeoPoint>, IComparable
    {
        ...
        public bool Equals(GeoPoint other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        ...
        public int CompareTo(GeoPoint other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
