...
namespace TLSharp.Rpc.Types
{
    public sealed class User : ITlType, IEquatable<User>, IComparable<User>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x200250ba;
        ...
        {
            uint ITlTypeTag.TypeNumber => 0x2e13f4c3;
        ...
        internal static User Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0x200250ba: return (User) EmptyTag.DeserializeTag(br);
                case 0x2e13f4c3: return (User) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0x200250ba, 0x2e13f4c3 });
            }
        }
        ...
        public bool Equals(User other) => !ReferenceEquals(other, null) && _tag.Equals(other._tag);
        public override bool Equals(object obj) => obj is User x && Equals(x);
        public static bool operator ==(User a, User b) => a?.Equals(b) ?? ReferenceEquals(b, null);
        ...
        public static bool operator <=(User a, User b) => a.CompareTo(b) <= 0;
        public static bool operator <(User a, User b) => a.CompareTo(b) < 0;
        public static bool operator >(User a, User b) => a.CompareTo(b) > 0;
        public static bool operator >=(User a, User b) => a.CompareTo(b) >= 0;
