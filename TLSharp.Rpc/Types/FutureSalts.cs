...
namespace TLSharp.Rpc.Types
{
    public sealed class FutureSalts : ITlType, IEquatable<FutureSalts>, IComparable<FutureSalts>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xae500895;
        ...
        internal static FutureSalts Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xae500895: return (FutureSalts) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xae500895 });
            }
        }
