...
namespace TLSharp.Rpc.Types
{
    public sealed class MsgsStateReq : ITlType, IEquatable<MsgsStateReq>, IComparable<MsgsStateReq>, IComparable
    {
        ...
        public bool Equals(MsgsStateReq other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpPair == other.CmpPair);
        public override bool Equals(object other) => other is MsgsStateReq x && Equals(x);
        public static bool operator ==(MsgsStateReq x, MsgsStateReq y) => x?.Equals(y) ?? ReferenceEquals(y, null);
        public static bool operator !=(MsgsStateReq x, MsgsStateReq y) => !(x == y);

        public int CompareTo(MsgsStateReq other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpPair.CompareTo(other.CmpPair);
        ...
        public static bool operator <=(MsgsStateReq x, MsgsStateReq y) => x.CompareTo(y) <= 0;
        public static bool operator <(MsgsStateReq x, MsgsStateReq y) => x.CompareTo(y) < 0;
        public static bool operator >(MsgsStateReq x, MsgsStateReq y) => x.CompareTo(y) > 0;
        public static bool operator >=(MsgsStateReq x, MsgsStateReq y) => x.CompareTo(y) >= 0;
        ...
        public override string ToString() => $"MsgsStateReq.{_tag.GetType().Name}{_tag}";
    }
}