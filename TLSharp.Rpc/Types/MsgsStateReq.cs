...
namespace TLSharp.Rpc.Types
{
    public sealed class MsgsStateReq : ITlType, IEquatable<MsgsStateReq>, IComparable<MsgsStateReq>, IComparable
    {
        ...
        {
            uint ITlTypeTag.TypeNumber => 0xda69fb52;
        ...
        internal static MsgsStateReq Deserialize(BinaryReader br)
        {
            ...
            switch (typeNumber)
            {
                case 0xda69fb52: return (MsgsStateReq) Tag.DeserializeTag(br);
                default: throw TlTransportException.UnexpectedTypeNumber(actual: typeNumber, expected: new uint[] { 0xda69fb52 });
            }
        }
