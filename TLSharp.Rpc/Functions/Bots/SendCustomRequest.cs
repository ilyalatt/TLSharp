...
namespace TLSharp.Rpc.Functions.Bots
{
    public sealed class SendCustomRequest : ITlFunc<T.DataJson>, IEquatable<SendCustomRequest>, IComparable<SendCustomRequest>, IComparable
    {
        ...
        public bool Equals(SendCustomRequest other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SendCustomRequest other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
