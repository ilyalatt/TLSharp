...
namespace TLSharp.Rpc.Functions.Bots
{
    public sealed class AnswerWebhookJsonQuery : ITlFunc<bool>, IEquatable<AnswerWebhookJsonQuery>, IComparable<AnswerWebhookJsonQuery>, IComparable
    {
        ...
        public bool Equals(AnswerWebhookJsonQuery other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(AnswerWebhookJsonQuery other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
