...
namespace TLSharp.Rpc.Functions.Contacts
{
    public sealed class GetStatuses : ITlFunc<Arr<T.ContactStatus>>, IEquatable<GetStatuses>, IComparable<GetStatuses>, IComparable
    {
        ...
        public bool Equals(GetStatuses other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(GetStatuses other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
