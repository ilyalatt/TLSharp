...
namespace TLSharp.Rpc.Functions.Contacts
{
    public sealed class Unblock : ITlFunc<bool>, IEquatable<Unblock>, IComparable<Unblock>, IComparable
    {
        ...
        public bool Equals(Unblock other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(Unblock other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
