...
namespace TLSharp.Rpc.Functions.Contacts
{
    public sealed class ExportCard : ITlFunc<Arr<int>>, IEquatable<ExportCard>, IComparable<ExportCard>, IComparable
    {
        ...
        public bool Equals(ExportCard other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(ExportCard other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
