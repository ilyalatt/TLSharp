...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class CreateChat : ITlFunc<T.UpdatesType>, IEquatable<CreateChat>, IComparable<CreateChat>, IComparable
    {
        ...
        public bool Equals(CreateChat other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(CreateChat other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
