...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetChats : ITlFunc<T.Messages.Chats>, IEquatable<GetChats>, IComparable<GetChats>, IComparable
    {
        ...
        public bool Equals(GetChats other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(GetChats other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
