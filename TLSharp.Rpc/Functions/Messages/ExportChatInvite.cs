...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class ExportChatInvite : ITlFunc<T.ExportedChatInvite>, IEquatable<ExportChatInvite>, IComparable<ExportChatInvite>, IComparable
    {
        ...
        public bool Equals(ExportChatInvite other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ExportChatInvite other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
