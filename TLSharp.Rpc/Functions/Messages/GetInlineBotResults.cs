...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetInlineBotResults : ITlFunc<T.Messages.BotResults>, IEquatable<GetInlineBotResults>, IComparable<GetInlineBotResults>, IComparable
    {
        ...
        public bool Equals(GetInlineBotResults other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetInlineBotResults other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
