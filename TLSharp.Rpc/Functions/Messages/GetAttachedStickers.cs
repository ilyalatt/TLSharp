...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetAttachedStickers : ITlFunc<Arr<T.StickerSetCovered>>, IEquatable<GetAttachedStickers>, IComparable<GetAttachedStickers>, IComparable
    {
        ...
        public bool Equals(GetAttachedStickers other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetAttachedStickers other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
