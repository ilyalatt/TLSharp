...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class SaveGif : ITlFunc<bool>, IEquatable<SaveGif>, IComparable<SaveGif>, IComparable
    {
        ...
        public bool Equals(SaveGif other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SaveGif other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
