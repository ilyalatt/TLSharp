...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class EditChatPhoto : ITlFunc<T.UpdatesType>, IEquatable<EditChatPhoto>, IComparable<EditChatPhoto>, IComparable
    {
        ...
        public bool Equals(EditChatPhoto other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(EditChatPhoto other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
