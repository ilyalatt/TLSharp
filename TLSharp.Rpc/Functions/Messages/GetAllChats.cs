...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetAllChats : ITlFunc<T.Messages.Chats>, IEquatable<GetAllChats>, IComparable<GetAllChats>, IComparable
    {
        ...
        public bool Equals(GetAllChats other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetAllChats other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
