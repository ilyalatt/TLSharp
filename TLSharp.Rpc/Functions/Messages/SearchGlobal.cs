...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class SearchGlobal : ITlFunc<T.Messages.Messages>, IEquatable<SearchGlobal>, IComparable<SearchGlobal>, IComparable
    {
        ...
        public bool Equals(SearchGlobal other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SearchGlobal other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
