...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class DeleteChatUser : ITlFunc<T.UpdatesType>, IEquatable<DeleteChatUser>, IComparable<DeleteChatUser>, IComparable
    {
        ...
        public bool Equals(DeleteChatUser other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(DeleteChatUser other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
