...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class ReportEncryptedSpam : ITlFunc<bool>, IEquatable<ReportEncryptedSpam>, IComparable<ReportEncryptedSpam>, IComparable
    {
        ...
        public bool Equals(ReportEncryptedSpam other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(ReportEncryptedSpam other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
