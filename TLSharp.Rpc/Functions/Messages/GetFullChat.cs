...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetFullChat : ITlFunc<T.Messages.ChatFull>, IEquatable<GetFullChat>, IComparable<GetFullChat>, IComparable
    {
        ...
        public bool Equals(GetFullChat other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(GetFullChat other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
