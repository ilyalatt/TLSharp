...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class EditChatTitle : ITlFunc<T.UpdatesType>, IEquatable<EditChatTitle>, IComparable<EditChatTitle>, IComparable
    {
        ...
        public bool Equals(EditChatTitle other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(EditChatTitle other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
