...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class CheckChatInvite : ITlFunc<T.ChatInvite>, IEquatable<CheckChatInvite>, IComparable<CheckChatInvite>, IComparable
    {
        ...
        public bool Equals(CheckChatInvite other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(CheckChatInvite other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
