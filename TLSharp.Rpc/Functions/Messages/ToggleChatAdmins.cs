...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class ToggleChatAdmins : ITlFunc<T.UpdatesType>, IEquatable<ToggleChatAdmins>, IComparable<ToggleChatAdmins>, IComparable
    {
        ...
        public bool Equals(ToggleChatAdmins other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ToggleChatAdmins other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
