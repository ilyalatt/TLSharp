...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetRecentStickers : ITlFunc<T.Messages.RecentStickers>, IEquatable<GetRecentStickers>, IComparable<GetRecentStickers>, IComparable
    {
        ...
        public bool Equals(GetRecentStickers other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetRecentStickers other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
