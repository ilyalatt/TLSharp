...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class SetBotShippingResults : ITlFunc<bool>, IEquatable<SetBotShippingResults>, IComparable<SetBotShippingResults>, IComparable
    {
        ...
        public bool Equals(SetBotShippingResults other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(SetBotShippingResults other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
