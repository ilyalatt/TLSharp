...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class ForwardMessage : ITlFunc<T.UpdatesType>, IEquatable<ForwardMessage>, IComparable<ForwardMessage>, IComparable
    {
        ...
        public bool Equals(ForwardMessage other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ForwardMessage other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
