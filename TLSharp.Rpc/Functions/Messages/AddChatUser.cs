...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class AddChatUser : ITlFunc<T.UpdatesType>, IEquatable<AddChatUser>, IComparable<AddChatUser>, IComparable
    {
        ...
        public bool Equals(AddChatUser other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(AddChatUser other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
