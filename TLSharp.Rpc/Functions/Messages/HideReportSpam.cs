...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class HideReportSpam : ITlFunc<bool>, IEquatable<HideReportSpam>, IComparable<HideReportSpam>, IComparable
    {
        ...
        public bool Equals(HideReportSpam other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(HideReportSpam other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
