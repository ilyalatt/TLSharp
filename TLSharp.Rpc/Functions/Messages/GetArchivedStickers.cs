...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetArchivedStickers : ITlFunc<T.Messages.ArchivedStickers>, IEquatable<GetArchivedStickers>, IComparable<GetArchivedStickers>, IComparable
    {
        ...
        public bool Equals(GetArchivedStickers other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetArchivedStickers other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
