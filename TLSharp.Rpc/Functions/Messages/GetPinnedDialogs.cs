...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetPinnedDialogs : ITlFunc<T.Messages.PeerDialogs>, IEquatable<GetPinnedDialogs>, IComparable<GetPinnedDialogs>, IComparable
    {
        ...
        public bool Equals(GetPinnedDialogs other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(GetPinnedDialogs other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
