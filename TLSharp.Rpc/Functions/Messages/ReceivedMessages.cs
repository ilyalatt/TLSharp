...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class ReceivedMessages : ITlFunc<Arr<T.ReceivedNotifyMessage>>, IEquatable<ReceivedMessages>, IComparable<ReceivedMessages>, IComparable
    {
        ...
        public bool Equals(ReceivedMessages other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ReceivedMessages other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
