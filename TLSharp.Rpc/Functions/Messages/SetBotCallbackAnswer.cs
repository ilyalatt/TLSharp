...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class SetBotCallbackAnswer : ITlFunc<bool>, IEquatable<SetBotCallbackAnswer>, IComparable<SetBotCallbackAnswer>, IComparable
    {
        ...
        public bool Equals(SetBotCallbackAnswer other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SetBotCallbackAnswer other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
