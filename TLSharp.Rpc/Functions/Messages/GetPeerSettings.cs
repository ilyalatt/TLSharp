...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class GetPeerSettings : ITlFunc<T.PeerSettings>, IEquatable<GetPeerSettings>, IComparable<GetPeerSettings>, IComparable
    {
        ...
        public bool Equals(GetPeerSettings other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetPeerSettings other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
