...
namespace TLSharp.Rpc.Functions.Messages
{
    public sealed class MigrateChat : ITlFunc<T.UpdatesType>, IEquatable<MigrateChat>, IComparable<MigrateChat>, IComparable
    {
        ...
        public bool Equals(MigrateChat other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(MigrateChat other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
