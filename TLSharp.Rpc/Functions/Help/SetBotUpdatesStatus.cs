...
namespace TLSharp.Rpc.Functions.Help
{
    public sealed class SetBotUpdatesStatus : ITlFunc<bool>, IEquatable<SetBotUpdatesStatus>, IComparable<SetBotUpdatesStatus>, IComparable
    {
        ...
        public bool Equals(SetBotUpdatesStatus other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SetBotUpdatesStatus other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
