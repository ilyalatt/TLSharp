...
namespace TLSharp.Rpc.Functions.Help
{
    public sealed class GetTermsOfService : ITlFunc<T.Help.TermsOfService>, IEquatable<GetTermsOfService>, IComparable<GetTermsOfService>, IComparable
    {
        ...
        public bool Equals(GetTermsOfService other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetTermsOfService other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
