...
namespace TLSharp.Rpc.Functions.Help
{
    public sealed class GetSupport : ITlFunc<T.Help.Support>, IEquatable<GetSupport>, IComparable<GetSupport>, IComparable
    {
        ...
        public bool Equals(GetSupport other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(GetSupport other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
