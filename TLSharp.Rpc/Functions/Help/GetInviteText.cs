...
namespace TLSharp.Rpc.Functions.Help
{
    public sealed class GetInviteText : ITlFunc<T.Help.InviteText>, IEquatable<GetInviteText>, IComparable<GetInviteText>, IComparable
    {
        ...
        public bool Equals(GetInviteText other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetInviteText other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
