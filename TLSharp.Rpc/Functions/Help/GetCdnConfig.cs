...
namespace TLSharp.Rpc.Functions.Help
{
    public sealed class GetCdnConfig : ITlFunc<T.CdnConfig>, IEquatable<GetCdnConfig>, IComparable<GetCdnConfig>, IComparable
    {
        ...
        public bool Equals(GetCdnConfig other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetCdnConfig other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
