...
namespace TLSharp.Rpc.Functions.Help
{
    public sealed class GetConfig : ITlFunc<T.Config>, IEquatable<GetConfig>, IComparable<GetConfig>, IComparable
    {
        ...
        public bool Equals(GetConfig other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetConfig other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
