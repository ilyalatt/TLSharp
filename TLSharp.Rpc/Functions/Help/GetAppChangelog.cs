...
namespace TLSharp.Rpc.Functions.Help
{
    public sealed class GetAppChangelog : ITlFunc<T.UpdatesType>, IEquatable<GetAppChangelog>, IComparable<GetAppChangelog>, IComparable
    {
        ...
        public bool Equals(GetAppChangelog other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetAppChangelog other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
