...
namespace TLSharp.Rpc.Functions.Auth
{
    public sealed class ResendCode : ITlFunc<T.Auth.SentCode>, IEquatable<ResendCode>, IComparable<ResendCode>, IComparable
    {
        ...
        public bool Equals(ResendCode other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(ResendCode other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
