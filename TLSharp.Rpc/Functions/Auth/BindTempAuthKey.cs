...
namespace TLSharp.Rpc.Functions.Auth
{
    public sealed class BindTempAuthKey : ITlFunc<bool>, IEquatable<BindTempAuthKey>, IComparable<BindTempAuthKey>, IComparable
    {
        ...
        public bool Equals(BindTempAuthKey other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(BindTempAuthKey other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
