...
namespace TLSharp.Rpc.Functions.Auth
{
    public sealed class DropTempAuthKeys : ITlFunc<bool>, IEquatable<DropTempAuthKeys>, IComparable<DropTempAuthKeys>, IComparable
    {
        ...
        public bool Equals(DropTempAuthKeys other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(DropTempAuthKeys other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
