...
namespace TLSharp.Rpc.Functions.Auth
{
    public sealed class RequestPasswordRecovery : ITlFunc<T.Auth.PasswordRecovery>, IEquatable<RequestPasswordRecovery>, IComparable<RequestPasswordRecovery>, IComparable
    {
        ...
        public bool Equals(RequestPasswordRecovery other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(RequestPasswordRecovery other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
