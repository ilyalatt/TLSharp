...
namespace TLSharp.Rpc.Functions.Auth
{
    public sealed class RecoverPassword : ITlFunc<T.Auth.Authorization>, IEquatable<RecoverPassword>, IComparable<RecoverPassword>, IComparable
    {
        ...
        public bool Equals(RecoverPassword other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(RecoverPassword other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
