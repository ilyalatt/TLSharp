...
namespace TLSharp.Rpc.Functions.Auth
{
    public sealed class ExportAuthorization : ITlFunc<T.Auth.ExportedAuthorization>, IEquatable<ExportAuthorization>, IComparable<ExportAuthorization>, IComparable
    {
        ...
        public bool Equals(ExportAuthorization other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ExportAuthorization other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
