...
namespace TLSharp.Rpc.Functions.Auth
{
    public sealed class CheckPhone : ITlFunc<T.Auth.CheckedPhone>, IEquatable<CheckPhone>, IComparable<CheckPhone>, IComparable
    {
        ...
        public bool Equals(CheckPhone other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(CheckPhone other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
