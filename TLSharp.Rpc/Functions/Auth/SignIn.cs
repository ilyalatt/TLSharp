...
namespace TLSharp.Rpc.Functions.Auth
{
    public sealed class SignIn : ITlFunc<T.Auth.Authorization>, IEquatable<SignIn>, IComparable<SignIn>, IComparable
    {
        ...
        public bool Equals(SignIn other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SignIn other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
