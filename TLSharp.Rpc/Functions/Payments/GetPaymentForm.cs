...
namespace TLSharp.Rpc.Functions.Payments
{
    public sealed class GetPaymentForm : ITlFunc<T.Payments.PaymentForm>, IEquatable<GetPaymentForm>, IComparable<GetPaymentForm>, IComparable
    {
        ...
        public bool Equals(GetPaymentForm other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetPaymentForm other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
