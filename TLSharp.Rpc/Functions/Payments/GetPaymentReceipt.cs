...
namespace TLSharp.Rpc.Functions.Payments
{
    public sealed class GetPaymentReceipt : ITlFunc<T.Payments.PaymentReceipt>, IEquatable<GetPaymentReceipt>, IComparable<GetPaymentReceipt>, IComparable
    {
        ...
        public bool Equals(GetPaymentReceipt other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetPaymentReceipt other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
