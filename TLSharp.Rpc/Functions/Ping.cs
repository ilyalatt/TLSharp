...
namespace TLSharp.Rpc.Functions
{
    public sealed class Ping : ITlFunc<T.Pong>, IEquatable<Ping>, IComparable<Ping>, IComparable
    {
        ...
        public bool Equals(Ping other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(Ping other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
