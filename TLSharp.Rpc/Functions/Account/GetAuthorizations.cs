...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class GetAuthorizations : ITlFunc<T.Account.Authorizations>, IEquatable<GetAuthorizations>, IComparable<GetAuthorizations>, IComparable
    {
        ...
        public bool Equals(GetAuthorizations other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetAuthorizations other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
