...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class GetPrivacy : ITlFunc<T.Account.PrivacyRules>, IEquatable<GetPrivacy>, IComparable<GetPrivacy>, IComparable
    {
        ...
        public bool Equals(GetPrivacy other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetPrivacy other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
