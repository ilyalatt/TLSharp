...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class SendConfirmPhoneCode : ITlFunc<T.Auth.SentCode>, IEquatable<SendConfirmPhoneCode>, IComparable<SendConfirmPhoneCode>, IComparable
    {
        ...
        public bool Equals(SendConfirmPhoneCode other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SendConfirmPhoneCode other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
