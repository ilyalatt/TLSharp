...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class ChangePhone : ITlFunc<T.User>, IEquatable<ChangePhone>, IComparable<ChangePhone>, IComparable
    {
        ...
        public bool Equals(ChangePhone other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ChangePhone other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
