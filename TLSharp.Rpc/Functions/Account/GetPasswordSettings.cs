...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class GetPasswordSettings : ITlFunc<T.Account.PasswordSettings>, IEquatable<GetPasswordSettings>, IComparable<GetPasswordSettings>, IComparable
    {
        ...
        public bool Equals(GetPasswordSettings other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetPasswordSettings other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
