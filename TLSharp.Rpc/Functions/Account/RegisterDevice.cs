...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class RegisterDevice : ITlFunc<bool>, IEquatable<RegisterDevice>, IComparable<RegisterDevice>, IComparable
    {
        ...
        public bool Equals(RegisterDevice other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(RegisterDevice other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
