...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class UpdateNotifySettings : ITlFunc<bool>, IEquatable<UpdateNotifySettings>, IComparable<UpdateNotifySettings>, IComparable
    {
        ...
        public bool Equals(UpdateNotifySettings other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(UpdateNotifySettings other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
