...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class ResetNotifySettings : ITlFunc<bool>, IEquatable<ResetNotifySettings>, IComparable<ResetNotifySettings>, IComparable
    {
        ...
        public bool Equals(ResetNotifySettings other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(ResetNotifySettings other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
