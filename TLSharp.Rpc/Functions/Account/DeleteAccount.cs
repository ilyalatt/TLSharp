...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class DeleteAccount : ITlFunc<bool>, IEquatable<DeleteAccount>, IComparable<DeleteAccount>, IComparable
    {
        ...
        public bool Equals(DeleteAccount other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(DeleteAccount other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
