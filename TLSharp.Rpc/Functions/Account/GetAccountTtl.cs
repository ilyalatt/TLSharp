...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class GetAccountTtl : ITlFunc<T.AccountDaysTtl>, IEquatable<GetAccountTtl>, IComparable<GetAccountTtl>, IComparable
    {
        ...
        public bool Equals(GetAccountTtl other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetAccountTtl other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
