...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class UpdateDeviceLocked : ITlFunc<bool>, IEquatable<UpdateDeviceLocked>, IComparable<UpdateDeviceLocked>, IComparable
    {
        ...
        public bool Equals(UpdateDeviceLocked other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(UpdateDeviceLocked other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
