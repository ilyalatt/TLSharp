...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class UpdatePasswordSettings : ITlFunc<bool>, IEquatable<UpdatePasswordSettings>, IComparable<UpdatePasswordSettings>, IComparable
    {
        ...
        public bool Equals(UpdatePasswordSettings other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(UpdatePasswordSettings other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
