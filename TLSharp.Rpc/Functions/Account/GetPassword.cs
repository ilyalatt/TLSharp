...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class GetPassword : ITlFunc<T.Account.Password>, IEquatable<GetPassword>, IComparable<GetPassword>, IComparable
    {
        ...
        public bool Equals(GetPassword other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetPassword other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
