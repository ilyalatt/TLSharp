...
namespace TLSharp.Rpc.Functions.Account
{
    public sealed class ReportPeer : ITlFunc<bool>, IEquatable<ReportPeer>, IComparable<ReportPeer>, IComparable
    {
        ...
        public bool Equals(ReportPeer other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ReportPeer other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
