...
namespace TLSharp.Rpc.Functions.Photos
{
    public sealed class UploadProfilePhoto : ITlFunc<T.Photos.Photo>, IEquatable<UploadProfilePhoto>, IComparable<UploadProfilePhoto>, IComparable
    {
        ...
        public bool Equals(UploadProfilePhoto other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(UploadProfilePhoto other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
