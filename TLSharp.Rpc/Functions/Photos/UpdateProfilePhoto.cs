...
namespace TLSharp.Rpc.Functions.Photos
{
    public sealed class UpdateProfilePhoto : ITlFunc<T.UserProfilePhoto>, IEquatable<UpdateProfilePhoto>, IComparable<UpdateProfilePhoto>, IComparable
    {
        ...
        public bool Equals(UpdateProfilePhoto other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(UpdateProfilePhoto other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
