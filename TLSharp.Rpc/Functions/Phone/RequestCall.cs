...
namespace TLSharp.Rpc.Functions.Phone
{
    public sealed class RequestCall : ITlFunc<T.Phone.PhoneCall>, IEquatable<RequestCall>, IComparable<RequestCall>, IComparable
    {
        ...
        public bool Equals(RequestCall other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(RequestCall other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
