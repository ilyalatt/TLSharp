...
namespace TLSharp.Rpc.Functions.Phone
{
    public sealed class SaveCallDebug : ITlFunc<bool>, IEquatable<SaveCallDebug>, IComparable<SaveCallDebug>, IComparable
    {
        ...
        public bool Equals(SaveCallDebug other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SaveCallDebug other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
