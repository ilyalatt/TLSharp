...
namespace TLSharp.Rpc.Functions.Phone
{
    public sealed class GetCallConfig : ITlFunc<T.DataJson>, IEquatable<GetCallConfig>, IComparable<GetCallConfig>, IComparable
    {
        ...
        public bool Equals(GetCallConfig other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(GetCallConfig other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
