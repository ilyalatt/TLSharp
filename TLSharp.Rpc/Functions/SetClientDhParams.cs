...
namespace TLSharp.Rpc.Functions
{
    public sealed class SetClientDhParams : ITlFunc<T.SetClientDhParamsAnswer>, IEquatable<SetClientDhParams>, IComparable<SetClientDhParams>, IComparable
    {
        ...
        public bool Equals(SetClientDhParams other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(SetClientDhParams other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
