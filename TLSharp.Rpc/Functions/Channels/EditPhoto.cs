...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class EditPhoto : ITlFunc<T.UpdatesType>, IEquatable<EditPhoto>, IComparable<EditPhoto>, IComparable
    {
        ...
        public bool Equals(EditPhoto other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(EditPhoto other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
