...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class UpdatePinnedMessage : ITlFunc<T.UpdatesType>, IEquatable<UpdatePinnedMessage>, IComparable<UpdatePinnedMessage>, IComparable
    {
        ...
        public bool Equals(UpdatePinnedMessage other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(UpdatePinnedMessage other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
