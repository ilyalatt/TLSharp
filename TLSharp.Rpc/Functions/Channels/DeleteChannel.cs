...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class DeleteChannel : ITlFunc<T.UpdatesType>, IEquatable<DeleteChannel>, IComparable<DeleteChannel>, IComparable
    {
        ...
        public bool Equals(DeleteChannel other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(DeleteChannel other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
