...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class ExportInvite : ITlFunc<T.ExportedChatInvite>, IEquatable<ExportInvite>, IComparable<ExportInvite>, IComparable
    {
        ...
        public bool Equals(ExportInvite other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ExportInvite other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
