...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class GetAdminedPublicChannels : ITlFunc<T.Messages.Chats>, IEquatable<GetAdminedPublicChannels>, IComparable<GetAdminedPublicChannels>, IComparable
    {
        ...
        public bool Equals(GetAdminedPublicChannels other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetAdminedPublicChannels other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
