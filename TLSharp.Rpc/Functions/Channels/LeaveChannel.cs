...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class LeaveChannel : ITlFunc<T.UpdatesType>, IEquatable<LeaveChannel>, IComparable<LeaveChannel>, IComparable
    {
        ...
        public bool Equals(LeaveChannel other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(LeaveChannel other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
