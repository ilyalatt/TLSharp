...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class JoinChannel : ITlFunc<T.UpdatesType>, IEquatable<JoinChannel>, IComparable<JoinChannel>, IComparable
    {
        ...
        public bool Equals(JoinChannel other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(JoinChannel other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
