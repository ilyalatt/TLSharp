...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class ExportMessageLink : ITlFunc<T.ExportedMessageLink>, IEquatable<ExportMessageLink>, IComparable<ExportMessageLink>, IComparable
    {
        ...
        public bool Equals(ExportMessageLink other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(ExportMessageLink other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
