...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class EditAbout : ITlFunc<bool>, IEquatable<EditAbout>, IComparable<EditAbout>, IComparable
    {
        ...
        public bool Equals(EditAbout other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(EditAbout other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
