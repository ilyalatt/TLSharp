...
namespace TLSharp.Rpc.Functions.Channels
{
    public sealed class InviteToChannel : ITlFunc<T.UpdatesType>, IEquatable<InviteToChannel>, IComparable<InviteToChannel>, IComparable
    {
        ...
        public bool Equals(InviteToChannel other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(InviteToChannel other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
