...
namespace TLSharp.Rpc.Functions
{
    public sealed class PingDelayDisconnect : ITlFunc<T.Pong>, IEquatable<PingDelayDisconnect>, IComparable<PingDelayDisconnect>, IComparable
    {
        ...
        public bool Equals(PingDelayDisconnect other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(PingDelayDisconnect other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
