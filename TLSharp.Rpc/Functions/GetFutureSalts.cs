...
namespace TLSharp.Rpc.Functions
{
    public sealed class GetFutureSalts : ITlFunc<T.FutureSalts>, IEquatable<GetFutureSalts>, IComparable<GetFutureSalts>, IComparable
    {
        ...
        public bool Equals(GetFutureSalts other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(GetFutureSalts other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
