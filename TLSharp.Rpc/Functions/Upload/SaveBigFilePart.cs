...
namespace TLSharp.Rpc.Functions.Upload
{
    public sealed class SaveBigFilePart : ITlFunc<bool>, IEquatable<SaveBigFilePart>, IComparable<SaveBigFilePart>, IComparable
    {
        ...
        public bool Equals(SaveBigFilePart other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(SaveBigFilePart other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
