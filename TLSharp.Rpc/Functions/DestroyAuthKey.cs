...
namespace TLSharp.Rpc.Functions
{
    public sealed class DestroyAuthKey : ITlFunc<T.DestroyAuthKeyRes>, IEquatable<DestroyAuthKey>, IComparable<DestroyAuthKey>, IComparable
    {
        ...
        public bool Equals(DestroyAuthKey other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(DestroyAuthKey other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
