...
namespace TLSharp.Rpc.Functions.Updates
{
    public sealed class GetState : ITlFunc<T.Updates.State>, IEquatable<GetState>, IComparable<GetState>, IComparable
    {
        ...
        public bool Equals(GetState other) => !ReferenceEquals(other, null) && CmpTuple == other.CmpTuple;
        ...
        public int CompareTo(GetState other) => !ReferenceEquals(other, null) ? CmpTuple.CompareTo(other.CmpTuple) : throw new ArgumentNullException(nameof(other));
