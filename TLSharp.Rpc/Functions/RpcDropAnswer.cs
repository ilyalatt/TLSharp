...
namespace TLSharp.Rpc.Functions
{
    public sealed class RpcDropAnswer : ITlFunc<T.RpcDropAnswer>, IEquatable<RpcDropAnswer>, IComparable<RpcDropAnswer>, IComparable
    {
        ...
        public bool Equals(RpcDropAnswer other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(RpcDropAnswer other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
