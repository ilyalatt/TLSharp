...
namespace TLSharp.Rpc.Functions
{
    public sealed class DestroySession : ITlFunc<T.DestroySessionRes>, IEquatable<DestroySession>, IComparable<DestroySession>, IComparable
    {
        ...
        public bool Equals(DestroySession other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(DestroySession other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
