...
namespace TLSharp.Rpc.Functions
{
    public sealed class ReqPq : ITlFunc<T.ResPq>, IEquatable<ReqPq>, IComparable<ReqPq>, IComparable
    {
        ...
        public bool Equals(ReqPq other) => !ReferenceEquals(other, null) && (ReferenceEquals(this, other) || CmpTuple == other.CmpTuple);
        ...
        public int CompareTo(ReqPq other) => ReferenceEquals(other, null) ? throw new ArgumentNullException(nameof(other)) : ReferenceEquals(this, other) ? 0 : CmpTuple.CompareTo(other.CmpTuple);
